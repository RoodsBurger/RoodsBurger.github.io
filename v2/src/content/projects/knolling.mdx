...
<MediaGrid
  items={[
    { src: "/artifacts/knolling_videos/tidy68_front.mov", type: "video", alt: "TidyNET front view" },
    { src: "/artifacts/knolling_videos/tidy68_top.mov", type: "video", alt: "TidyNET top view" },
    { src: "/artifacts/knolling_videos/tidy68_virtual.mov", type: "video", alt: "TidyNET virtual planner" },
  ]}
/>
