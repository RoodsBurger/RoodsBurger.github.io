---
title: "TidyNET"
summary: "An end-to-end deep learning system for robotic workspace organization that uses diffusion-based visual planning to turn clutter into order."
tags: ["Deep Learning", "Diffusion", "YOLO", "ROS2"]
category: ["code"]
order: 2
featured: true
cover: "/artifacts/knolling_main.webp"
