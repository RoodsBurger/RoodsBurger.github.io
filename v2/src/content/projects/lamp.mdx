...
<Model3DPair
  items={[
    {
      src: "/artifacts/lamp1.glb",
      alt: "Brushless lamp base, interactive 3D model",
      caption: "Base",
    },
    {
      src: "/artifacts/lamp2.glb",
      alt: "Brushless lamp core carrier, interactive 3D model",
      caption: "Core carrier",
    },
  ]}
/>
